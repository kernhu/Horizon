package cn.walkpast.utils.permission;
...
import cn.walkpast.utils.permission.callback.PermissionOriginResultCallBack;
...
public class PermissionUtil {
    ...
    private void requestPermissions() {
        ...
        Intent intent = new Intent(mActivity, PermissionHelpActivity.class);
