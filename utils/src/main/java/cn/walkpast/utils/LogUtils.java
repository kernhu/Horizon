    ...
    public static class Config {
        private Config() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && HorizonUtils.getApp().getExternalCacheDir() != null)
                sDefaultDir = HorizonUtils.getApp().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                sDefaultDir = HorizonUtils.getApp().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
